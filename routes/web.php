...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'installed', 'license-activate', 'backend_permission'], 'as' => 'admin.'], function () {
    ...
    Route::post('day-wise-sales-statistics', [DashboardController::class, 'dayWiseSalesStatistics']);
    Route::post('day-wise-order-summery', [DashboardController::class, 'dayWiseOrderSummery']);
    Route::post('day-wise-revenue-statistics', [DashboardController::class, 'dayWiseRevenueStatistics']);
    Route::get('profile', [ProfileController::class, 'index'])->name('profile');
    Route::get('profile/edit', [ProfileController::class, 'edit'])->name('profile.edit');
    Route::get('profile/bank/edit', [ProfileController::class, 'bankEdit'])->name('profile.bank-edit');
    ...
    Route::get('profile/address-index', [ProfileController::class, 'addressindex'])->name('profile.address-index');
    ...
    Route::put(
        'menu-items/{id}/modify',
        [MenuItemController::class, 'modifyUpdate']
    )->name('menu-items.modify.update');
    ...
    Route::get('reservation/status/update/{id}/{status}', [ReservationsController::class, 'statusUpdate'])->name('reservation.status.update');
