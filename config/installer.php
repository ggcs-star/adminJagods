...
return [
    ...
    */
    ...
    'item_name' => 'food-bank-food-order-app-with-laravel-admin-panel',
    /*
     |-----------------------------------------------------------------------------------------------
    ...
    'buyNowUrl' => 'https://codecanyon.net/item/foodbank-all-in-one-multi-restaurant-food-ordering-management-system/35543239',
    ...
    'demo' => [
        'domain' => 'food-bank.xyz',
        'hosts'   => [
            'demo.food-bank.xyz/v1',
        ],
    ],
