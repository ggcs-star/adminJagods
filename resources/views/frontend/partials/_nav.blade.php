...
<div class="header fixed sticky"
     style="background:#EFF0F6 !important;">
            ...
            <div class="header-content">
                ...
                <a href="{{ route('home') }}" class="header-logo">
                    <img src="{{ themeSetting('site_logo') ? themeSetting('site_logo')->logo : asset('images/seeder/settings/logo.png') }}"
                        data-sticky-logo="{{ themeSetting('site_logo') ? themeSetting('site_logo')->logo : asset('images/seeder/settings/logo.png') }}" alt="logo">
                </a>
    ...
    <div class="header-auth">
        ...
        <!--style="background:#ffffff; color:#6C34CC; border:none; padding:8px 15px; border-radius:6px;">-->
        <!--    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"-->
        <!--        xmlns="http://www.w3.org/2000/svg">-->
        <!--        <path-->
        ...
        <!--    <a href="{{ route('login') }}" style="background:#ffffff; color:#6C34CC;">-->
        <!--        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"-->
        <!--            xmlns="http://www.w3.org/2000/svg">-->
        <!--            <path-->
        ...
        <!--    </a>-->
        <!--    <a href="{{ route('register') }}" style="background:#ffffff; color:#6C34CC;">-->
        <!--        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"-->
        <!--            xmlns="http://www.w3.org/2000/svg">-->
        <!--            <path-->
        ...
        <!--</nav>-->
      <nav>
    <a href="https://play.google.com/store/apps/details?id=com.jagods.customer" class="app-download-btn">
        Get The App
    </a>
</nav>
...
@else
    ...
    <div class="header-account">
        <button type="button" class="header-account-btn" style="background:#ffffff; color:#6C34CC;">
        ...
        <nav class="header-account-navs">
            <a href="{{ route('account.profile') }}" style="background:#ffffff; color:#6C34CC;"><i
                    class="lni lni-cog"></i><span>{{ __('topbar.account') }}</span></a>
            <a href="{{ route('account.order') }}" style="background:#ffffff; color:#6C34CC;"><i
                    class="lni lni-cart-full"></i><span>{{ __('topbar.my_orders') }}</span></a>
            <a href="{{ route('account.reservations') }}" style="background:#ffffff; color:#6C34CC;"><i
                    class="lni lni-coffee-cup"></i><span>{{ __('topbar.reservations') }}</span></a>
            <a href="{{ route('logout') }}" style="background:#ffffff; color:#6C34CC;"
    ...
    <a href="{{ route('admin.restaurants.index') }}" class="header-btn" style="background:#ffffff; color:#6C34CC;">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
   ...
   class="header-btn" 
   style="background:#ffffff !important; color:#6C34CC !important;">

    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M14.3334 7.26671V2.73337C14.3334 1.73337 13.9067 1.33337 12.8467 1.33337H10.1534C9.09341 1.33337 8.66675 1.73337 8.66675 2.73337V7.26671C8.66675 8.26671 9.09341 8.66671 10.1534 8.66671H12.8467C13.9067 8.66671 14.3334 8.26671 14.3334 7.26671Z"
            fill="#6C34CC"/>
        <path d="M7.33341 8.73337V13.2667C7.33341 14.2667 6.90675 14.6667 5.84675 14.6667H3.15341C2.09341 14.6667 1.66675 14.2667 1.66675 13.2667V8.73337C1.66675 7.73337 2.09341 7.33337 3.15341 7.33337H5.84675C6.90675 7.33337 7.33341 7.73337 7.33341 8.73337Z"
            fill="#6C34CC"/>
        <path d="M14.3334 13.2667V11.4C14.3334 10.4 13.9067 10 12.8467 10H10.1534C9.09341 10 8.66675 10.4 8.66675 11.4V13.2667C8.66675 14.2667 9.09341 14.6667 10.1534 14.6667H12.8467C13.9067 14.6667 14.3334 14.2667 14.3334 13.2667Z"
            fill="#6C34CC"/>
        <path d="M7.33341 4.60004V2.73337C7.33341 1.73337 6.90675 1.33337 5.84675 1.33337H3.15341C2.09341 1.33337 1.66675 1.73337 1.66675 2.73337V4.60004C1.66675 5.60004 2.09341 6.00004 3.15341 6.00004H5.84675C6.90675 6.00004 7.33341 5.60004 7.33341 4.60004Z"
            fill="#6C34CC"/>
    </svg>

    <span style="color:#6C34CC !important;">
        {{ __('topbar.dashboard') }}
    </span>
</a>
...
.app-download-btn {
    ...
    border: 2px solid #ffffff;   /* fixed width */
    border-radius: 10px;
...
.app-download-btn:hover {
    background: #ffffff;
    color: #6C34CC;
    border: 2px solid #6C34CC;   /* same width */
}
