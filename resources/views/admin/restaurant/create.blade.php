                        ...
                        <div class="db-card">
                            ...
                            <div class="db-card-body">
                                <div class="row">
                                    ...
                                    <div class="form-col-12 sm:form-col-12 md:form-col-12">
                                        <label class="db-field-title" for="module">
                                            {{ __('levels.modules') }}
                                        </label>
                                    ...
                                    <div class="form-col-12">
                                        ...
                                        <div class="db-field-down-arrow">
                                            <select name="restroType" id="restroType"
                                                ...
                                                <option value="{{ RestroType::VEG }}"
                                                    {{ old('restroType') == RestroType::VEG ? 'selected' : '' }}>
                                                    Veg
                                                </option>

                                                <option value="{{ RestroType::NON_VEG }}"
                                                    {{ old('restroType') == RestroType::NON_VEG ? 'selected' : '' }}>
                                                    Non-Veg
                                                </option>

                                                <option value="{{ RestroType::VEG_AND_NON_VEG }}"
                                                    {{ old('restroType') == RestroType::VEG_AND_NON_VEG ? 'selected' : '' }}>
                                                    Veg & Non-Veg
                                                </option>
                        ...
                        <div class="db-card mt-5">
                            ...
                            <div class="db-card-body">
                                <div class="row">
                                            ...
                                            <select name="waiter_status"
                                                ...
                                                @foreach (trans('waiter_statuses') as $waiter_statusKey => $waiter_status)
                                                    <option value="{{ $waiter_statusKey }}"
                                                        {{ old('waiter_status') == $waiter_statusKey ? 'selected' : '' }}>
                                                        {{ $waiter_status }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-col-12">
                                        <label class="db-field-title "
                                            for="sort_order">{{ __('levels.sort_order') }}</label>
                                        <input type="number" name="sort_order"
                                            class="db-field-control @error('sort_order') invalid @enderror"
                                            id="sort_order" value="{{ old('sort_order') }}"></input>
                                        @error('sort_order')
                                            <small class="db-field-alert">{{ $message }}</small>
                                        @enderror
                                    </div>
