						...
						<div class="row">
							...
							<div class="col-12 sm:col-6 md:col-4 xl:col-3">
								...
								<select name="restroType" id="restroType"
									...
									<option value="veg" {{ old('restroType', $menuItem->restroType ?? '') == 'veg' ? 'selected' : '' }}>
										Veg
									</option>

									<option value="non-veg" {{ old('restroType', $menuItem->restroType ?? '') == 'non-veg' ? 'selected' : '' }}>
										Non-Veg
									</option>
								</select>
							...
							<div class="form-col-12">
								...
								<textarea name="description"
									class="db-field-control @error('description') invalid @enderror" id="editor" cols="30"
									rows="10">{{ old('description', $menuItem->description) }}</textarea>
								@error('description')
									<small class="db-field-alert">{{ $message }}</small>
								@enderror
							</div>
