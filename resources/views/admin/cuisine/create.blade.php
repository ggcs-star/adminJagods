                                ...
                                <div class="db-field-down-arrow">
                                    <select name="restroType" id="restroType"
                                        ...
                                        <option value="{{ \App\Enums\RestroType::VEG }}"
                                            {{ old('restroType') == \App\Enums\RestroType::VEG ? 'selected' : '' }}>
                                            Veg
                                        </option>

                                        <option value="{{ \App\Enums\RestroType::NON_VEG }}"
                                            {{ old('restroType') == \App\Enums\RestroType::NON_VEG ? 'selected' : '' }}>
                                            Non Veg
                                        </option>

                                        <option value="{{ \App\Enums\RestroType::VEG_AND_NON_VEG }}"
                                            {{ old('restroType') == \App\Enums\RestroType::VEG_AND_NON_VEG ? 'selected' : '' }}>
                                            Veg & Non Veg
                                        </option>
                                    </select>
                                </div>
