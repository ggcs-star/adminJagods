        ...
        <div class="col-12">
            <div class="db-card">
                ...
                <div class="db-table-responsive">
                    <table class="db-table table stripe" id="maintable" data-url="{{ route('admin.category.index') }}"
                        data-status="{{ \App\Enums\Status::ACTIVE }}"
                        data-hidecolumn="{{ auth()->user()->can('category_edit') || auth()->user()->can('category_delete') }}">
                        <thead class="db-table-head">
                            <tr class="db-table-head-tr">
                                <th class="db-table-head-th">{{ __('levels.name') }}</th>
                                <th class="db-table-head-th">Category Group</th>
                                <th class="db-table-head-th">Main Category</th>
